...
flags.DEFINE_enum("user_race", "P", sc2_env.races.keys(), "User's race.")
flags.DEFINE_enum("bot_race", "T", sc2_env.races.keys(), "AI race.")
...
def main(unused_argv):
    ...
    with run_config.start(full_screen=FLAGS.full_screen) as controller:
        ...
        if FLAGS.render:
            ...
            if FLAGS.map and FLAGS.save_replay and obs.player_result:
